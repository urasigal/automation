...
public class ZenAddReceiverTest extends BaseTestZixiMainComponents{
	...
	@Parameters({"zenUserName", "zenUserPass", "zenLogin_ip", "zenUiport", "receiverName", "receiverUser", "receiverPass", "shhKeyName", "accessTagName", "testid"})
	@Test
	public void addFeederToZen(String zenUserName, String zenUserPass, String zenLogin_ip, String zenUiport, String receiverName, String receiverUser, String receiverPass, String shhKeyName, String accessTagName, String testid) throws Exception {
