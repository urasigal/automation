...
public class ZenAddClusterTest extends BaseTestZixiMainComponents{
	...
	"bx_version", "aws_account_name", "api_user", "api_password", "testid"})
	@Test
	...
	String bx_version, String aws_account_name, String api_user, String api_password, String testid) throws Exception {
