...
public class ZenAddClusterTest extends BaseTestZixiMainComponentsZen{
	...
	"bx_version", "aws_account_name", "region", "key_pair", "security_group", "min_size", "max_size", "api_user", "api_password", "testid"})
	@Test
	...
	String bx_version, String aws_account_name, String region, String key_pair, String security_group, String min_size, String max_size, String api_user, String api_password, String testid) throws Exception {
		...
		clusterName, resource_tag_name, can_input, can_output, can_process, http_streaming_port, auth_mode,
		allow_unmanaged_inputs, allow_unmanaged_outputs, dns_prefix, is_auto_scaling, activation_key,
		bx_version, aws_account_name, region, key_pair, security_group, min_size, max_size, api_user, api_password);
