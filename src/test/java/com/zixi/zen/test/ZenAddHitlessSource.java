...
public class ZenAddHitlessSource extends BaseTestZixiMainComponentsZen{
	...
	@Parameters({"zenUser", "zenPass", "zenLogin_ip", "zenUiPort", "name", "broadcaster_cluster_id", "feeder_id", "broadcaster_id", "target_broadcaster_id",
	...
	@Test
	public void addFeederSourceToZen(String zenUser, String zenPass, String zenLogin_ip, String zenUiPort, String name, 
		...
		buildTestParametersString(new String[] {"zenUser", "zenPass", "zenLogin_ip", "zenUiPort", "name", "broadcaster_cluster_id", "feeder_id", "broadcaster_id", "target_broadcaster_id",
		"input_id", "max_bitrate", "hitless_failover_source_ids", "latency", "monitor_pids_change", "resource_tag_ids",
		"password", "encryption", "encryption_key", "allow_outputs", "outputs_password", "monitor_only", "testid"}, 
		new String[] {zenUser, zenPass, zenLogin_ip, zenUiPort, name, broadcaster_cluster_id, feeder_id, broadcaster_id, target_broadcaster_id,
		input_id, max_bitrate, hitless_failover_source_ids, latency, monitor_pids_change, resource_tag_ids,
		password, encryption, encryption_key, allow_outputs, outputs_password, monitor_only, testid});
		
		driverReslut = ((AddFeederSourceDriver) testDriver).addHitlessSource(zenUser, zenPass, zenLogin_ip, zenUiPort, name, broadcaster_cluster_id, feeder_id, broadcaster_id, target_broadcaster_id,
				input_id, max_bitrate, hitless_failover_source_ids, latency, monitor_pids_change, resource_tag_ids,
