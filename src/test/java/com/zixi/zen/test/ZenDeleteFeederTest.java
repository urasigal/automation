...
public class ZenDeleteFeederTest extends BaseTestZixiMainComponentsZen{
	...
	@Test
	public void deleteSource(String zenUser, String zenPass, String zenLogin_ip, String zenUiPort, String feeder_name, String testid) throws Exception {
		...
		driverReslut = ((ZenDeleteChannelDriver) testDriver).deleteSource(zenUser, zenPass, zenLogin_ip, zenUiPort, feeder_name);
