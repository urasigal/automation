...
public class BroadcasterAdaptiveStairsImpairmentTest extends BaseTest {
	...
	// Test parameters.
	@Parameters({"maxwell_address", "standart_impairment_server_api_port", "flow_match_control_setmatch", "impairment_control_setimpair", "testid"})
	@Test
	...
	String impairment_control_setimpair, String testid) throws Exception {
		...
		testParameters = buildTestParametersString(new String[] { "maxwell_address", "standart_impairment_server_api_port", "flow_match_control_setmatch", 
