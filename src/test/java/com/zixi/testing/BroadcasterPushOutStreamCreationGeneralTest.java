...
public class BroadcasterPushOutStreamCreationGeneralTest extends BaseTest {
	...
	String stream, String port, String uiport, String alias, String id, String link1, String link2, String bond_links, String testid) throws Exception {
		...
		Assert.assertEquals(((BroadcasterPushOutStreamCreationDriver) testDriver).testIMPLRedund(userName, userPass, login_ip, host, latency, fec_force,
		session, fec_adaptive, nic, fec_block, type, snames, fec_aware, fec_overhead, stream, port, uiport, alias, id, link1, link2, bond_links), "Output " + id + " added.");
