...
public class BroadcasterHlsPullInputTest extends BaseTestZixiMainComponents {
	...
	@Parameters({ "userName", "userPass", "login_ip", "uiport", "type", "id", "matrix", "max_outputs", "mcast_out", "time_shift", "enc_type", "enc_key", "old", "fast_connect",
		"kompression", "rec_history", "rec_duration", "rec_path", "rec_template", "hls_url", "hls_adaptive", "testid"})
	@Test
	...
	String kompression, String rec_history, String rec_duration, String rec_path, String rec_template, String hls_url, String hls_adaptive, String testid) throws Exception {
		...
		kompression, rec_history, rec_duration, rec_path, rec_template, hls_url, hls_adaptive);
