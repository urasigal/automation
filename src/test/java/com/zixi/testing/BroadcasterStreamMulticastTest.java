...
public class BroadcasterStreamMulticastTest  extends BaseTestZixiMainComponents{
	...
	String multicast, String multi_src, String nic, String device, String rtp_type, String enc_key, @Optional("0") String rist, String testid) throws Exception {
		...
		bx2_uiport, type, id, matrix, max_outputs, mcast_out, time_shift, old, fast_connect, kompression,
		enc_type, rec_history, rec_duration, ts_port, max_bitrate, multicast, multi_src, nic, device, rtp_type, enc_key, rist, testid});
		...
		kompression, bx2_uiport, "", enc_type, mcast_out, "", max_outputs, "1", "0", rist);
