...
public class BroadcasterAddTranscoderProfileTest extends BaseTestZixiMainComponents {
	...
	@Parameters({ "userName", "userPass", "login_ip", "uiport", "profile_name", "enc", "bitrate", "gop", "fixed_gop", "closed_gop", "performance",
	"b_frames", "frame_type", "profile", "level", "bitrate_mode", "ref_frames", "idr_int", "cavlc", "brightness", "contrast", "fps",
	...
	throws Exception {
		...
		Assert.assertEquals( ((BroadcasterAddTranscoderProfileDriver) testDriver).testIMPL(userName, userPass, login_ip, uiport,
		profile_name, enc, bitrate, gop, fixed_gop, closed_gop, performance, b_frames, frame_type,
		profile, level, bitrate_mode, ref_frames, idr_int, cavlc, brightness, contrast, fps,
