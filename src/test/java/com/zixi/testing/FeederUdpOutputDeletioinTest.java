...
public class FeederUdpOutputDeletioinTest extends BaseTestZixiMainComponents{
	...
	String mip, String port, String ip, String prog, String chan, String type, String host, String udpport, String testid) throws Exception {
		...
		buildTestParametersString(new String[] { userName, userPass, login_ip, uiport, id, mip,port, ip, prog, chan, type,host, udpport ,testid }, 
