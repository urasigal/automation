...
public class BroadcasterCreateAddaptiveGroupTest extends BaseTestZixiMainComponents {
	...
	"multicast", "streams", "bitrates", "max_time", "remux", "iframes", "file", "scte35", "ts_split", "order_ascending",  "testid" })
	@Test
	...
	String order_ascending, String testid)throws Exception {
		...
		"scte35", "ts_split", "order_ascending", "testid" }, 
		...
		zixi, hls, hds, mpd, mmt, compress_zixi, multicast, streams, bitrates, max_time, remux, iframes, file, scte35, ts_split, order_ascending );
