...
public class FeederAddFailoverGroupTest extends BaseTestZixiMainComponents{
	...
	public void broadcasterPullInCreation(String userName,String userPass, String login_ip, String uiport,
			String group_member_streams, String group_name, String testid)
	throws Exception {
		...
		buildTestParametersString(new String[] {"userName","userPass", "login_ip", "uiport", "group_member_streams", "group_name", "testid"},
		new String[] {userName, userPass, login_ip, uiport, group_member_streams, group_name, testid});
		
		driverReslut = ((FeederInputStreamDeletionDriver) testDriver)
		.addFailoverGroup(userName, userPass, login_ip, uiport, group_member_streams, group_name);
