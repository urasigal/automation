...
public class BroadcasterAddIntelTranscoderProfileTest extends BaseTest {
	...
	@Parameters({"userName", "userPass", "login_ip", "uiport", "mode", "profile_name","enc", "bitrate", "gop", "fixed_gop", "closed_gop", "copy_gop",  "performance",
	"b_frames", "frame_type", "profile", "level", "bitrate_mode", "ref_frames", "hrd", "idr_int", "cavlc", "brightness", "contrast", "fps",
	"width", "height","crf", "tune", "max_bitrate", "testid" })
	...
	String width, String height, String crf, String tune, String max_bitrate, String testid)
	throws Exception {
	...
	// Retrieve the product version. Parameters: 1 - host, 2 - user interface port, 3 - product login name, 4 - product login password.
		...
		enc, bitrate, gop, fixed_gop, closed_gop, copy_gop, performance,b_frames, frame_type, profile, level, bitrate_mode,
		ref_frames, hrd, idr_int, cavlc, brightness, contrast, fps,
		width, height,crf, tune, max_bitrate), "Profile added, existing transcoded streams may be restarted.");
	}
}
