...
public class BroadcasterAddIntelTranscoderProfileTest extends BaseTestZixiMainComponents {
	...
	String width, String height, String crf, String tune, @Optional("0") String keep_ar,  String max_bitrate,  @Optional("0") String x264_two_pass, String testid) throws Exception {
		...
		"width", "height","crf", "tune", "keep_ar",  "max_bitrate", "x264_two_pass","testid"}, 
						
		new String[] {userName, userPass, login_ip, uiport, mode, profile_name, enc, bitrate, gop, fixed_gop, closed_gop, copy_gop, performance,
		b_frames, frame_type, profile, level, bitrate_mode, ref_frames, hrd, idr_int, cavlc, brightness, contrast, fps, width, height,crf, tune, keep_ar,  max_bitrate, x264_two_pass, testid});
		...
		ref_frames, hrd, idr_int, cavlc, brightness, contrast, fps, width, height,crf, tune, keep_ar, max_bitrate, x264_two_pass);
