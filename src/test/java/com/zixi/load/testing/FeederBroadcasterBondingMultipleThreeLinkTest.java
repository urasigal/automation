...
public class FeederBroadcasterBondingMultipleThreeLinkTest extends BaseTestZixiMainComponents{
		...
		String max_outputs, String on, String password, String dec_type, String dec_key, String number_of_streams, String testid) throws Exception {
			...
			// Actual test method.
			driverReslut = ((FeederBroadcasterBondingMultipleThreeLinkDriver) testDriver).testIMPL
