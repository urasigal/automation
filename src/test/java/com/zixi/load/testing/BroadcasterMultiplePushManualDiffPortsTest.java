...
public class BroadcasterMultiplePushManualDiffPortsTest extends BaseTestZixiMainComponents{
	...
	"nic", "fec_block", "type_bx2", "snames", "fec_aware", "fec_overhead", "stream", "port", "uiport_bx2", "alias", "id_bx2", "enc_type", "enc_key", "dec_type", "dec_key",
	...
	String port, String uiport_bx2, String alias, String id_bx2, String enc_type, String enc_key, @Optional("") String dec_type, @Optional("") String dec_key, String number_of_streams,
	@Optional("0") String mixed, String testid) throws Exception {
		...
		"force_p2p", "mcast_ip", "mcast_force", "mcast_port", "type_bx1", "uiport_bx1", "analyze", "mcast_ttl", "id_bx1", "mcast_out",
		"complete", "max_outputs", "on", "password", "host", "latency_bx2", "fec_force", "session", "fec_adaptive",
		"nic", "fec_block", "type_bx2", "snames", "fec_aware", "fec_overhead", "stream", "port", "uiport_bx2", "alias", "id_bx2", "dec_type", "dec_key",
		...
		new String[] { userName_bx1,  userName_bx2,  userPass_bx1,  userPass_bx2,  login_ip_bx1, 
		 ...
		 port,  uiport_bx2,  alias,  id_bx2, dec_type, dec_key, number_of_streams, mixed, testid });
		
		driverReslut = ((BroadcasterMultiplePushDriver) testDriver).testIMPLManualDiffPorts(
