...
public class AdaptiveLoadClientInterfaceTest extends BaseTestZixiMainComponents
{
...
//		driverReslut = ((BroadcasterMultipleCreationDriver) testDriver).adaptive(userName, userPass, Host, login_ip, id,
