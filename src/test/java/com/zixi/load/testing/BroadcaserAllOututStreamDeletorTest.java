...
public class BroadcaserAllOututStreamDeletorTest extends BaseTestZixiMainComponents{
	
	@Parameters({"testid"})
	@BeforeClass
	public void testInit(String testid) { testDriver = new BroadcaserAllOutputStreamDeletorDriver(); }
