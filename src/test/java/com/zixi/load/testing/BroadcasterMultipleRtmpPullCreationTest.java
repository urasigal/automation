...
public class BroadcasterMultipleRtmpPullCreationTest extends BaseTestZixiMainComponents
{
	...
	"rtmp_user", "rtmp_bitrate", "rtmp_passwd", "uiport", "mcast_ttl", "rtmp_latency", "mcast_out", "complete", "max_outputs", "on", "number_of_streams", "testid"})
	// Test method section. 
	@Test
